...
export class AirlineService{
    ...
    mockedAirlines(): Array<Airline>{
        ...
        const a1 = new Airline(1,"Qatar Airways","Doha","Opis 1",5,"Spisak destinacija 1");
        const a2 = new Airline(2,"Emirates","Dubai","Opis 2",2,"Spisak Destinacija 2");
        const a3 = new Airline(3,"EVA Air","London","Opis 3",3,"Spisak destinacija 3");
