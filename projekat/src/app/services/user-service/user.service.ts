...
export class UserService{
    ...
    mockedUsers(): Array<User>{
        ...
        const f1=new Flight(0,"Beograd","Budimpesta",new Date(2020,10,14,9,30,0,0),new Date(2020,10,14,11,30,0,0),110,0,null,250);
        const f2=new Flight(1,"Beograd","Bec",new Date(2020,10,14,12,30,0,0),new Date(2020,10,14,11,30,0,0),210,0,null,330);
